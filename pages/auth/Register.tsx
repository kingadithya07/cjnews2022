...
const Register: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (regError) {
      // Handle the specific Supabase error about disabled signups
      if (regError.message.toLowerCase().includes('email signups are disabled')) {
        setError("Network Access Restricted");
        setDevNote("Supabase Dashboard Action Required: Go to Auth -> Providers -> Email and enable 'Allow new users to sign up'. Even though we use usernames, Supabase requires the Email provider to be enabled for this internal mapping strategy.");
      } else {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="max-w-lg w-full bg-white rounded-[3rem] shadow-2xl p-8 md:p-12 border border-gray-100">
        ...
        {devNote && (
          <div className="mb-6 p-5 bg-gray-900 text-white rounded-2xl border border-red-600/50 shadow-xl">
            <div className="flex items-center mb-2">
              <svg className="w-5 h-5 text-red-600 mr-2" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path></svg>
              <h4 className="text-[10px] font-black uppercase tracking-widest">Developer System Notice</h4>
            </div>
