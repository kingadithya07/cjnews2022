...
const Register: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (data?.user) {
      ...
      // Simulating a secure internal message appearing after a short delay
      setTimeout(() => {
        ...
        <div className="max-w-md w-full bg-white rounded-[3rem] shadow-2xl p-10 border border-gray-100 relative overflow-hidden">
          ...
          <div className="text-center mb-10 relative z-10">
            ...
            <h2 className="text-3xl font-black text-gray-900 tracking-tighter uppercase mb-2">
              Identity <span className="text-red-600">Verification</span>
            </h2>
            <p className="text-gray-400 text-sm font-medium">An internal secure code has been generated for your session.</p>
          </div>

          {error && (
            <div className="mb-6 p-4 bg-red-50 text-red-600 text-xs font-bold rounded-2xl border border-red-100 text-center uppercase tracking-widest">
              {error}
            </div>
          )}
          ...
          <div className="space-y-8">
            <div>
              <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-4 text-center">Enter 6-Digit Secure Code</label>
              <input 
                type="text" 
                maxLength={6}
            ...
            {showCodeHint && (
              <div className="p-6 bg-gray-900 rounded-[2rem] border border-white/10 animate-slideUp">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <span className="text-[10px] font-black uppercase text-white tracking-widest">Internal Secure Message</span>
                </div>
                <p className="text-white/60 text-[11px] font-medium leading-relaxed mb-4">
                  Your verification code is ready. For security reasons, do not share this code with anyone.
                </p>
    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="max-w-lg w-full bg-white rounded-[3rem] shadow-2xl p-8 md:p-12 border border-gray-100">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm font-medium">Join the CJNewsHub newsroom network</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            <label className="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 ml-1">Full Legal Name</label>
            <input 
              type="text" 
              required
          ...
          <div>
            <label className="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 ml-1">Professional Email</label>
            <input 
              type="email" 
              required
              className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-red-600/10 focus:border-red-600 outline-none transition-all font-bold"
          ...
          <div className="pt-6">
            ...
            >
              {loading ? 'Processing...' : 'Secure Join'}
            </button>
          </div>
        </form>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-xs font-medium">
            Already registered? <a href="#/login" className="text-red-600 font-bold hover:underline">Sign In</a>
          </p>
        </div>
      </div>
    </div>
